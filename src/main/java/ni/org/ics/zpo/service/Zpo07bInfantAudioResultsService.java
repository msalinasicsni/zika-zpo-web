...
public class Zpo07bInfantAudioResultsService {
    ...
    public List<Zpo07bInfantAudioResults> getZpo07bInfantAudioResultstByUser(String username){
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createQuery("FROM Zpo07bInfantAudioResults zpo07 where zpo07.pasive = '0' and zpo07.recordId in (select zpo00.recordId from ZpoInfantData zpo00 where zpo00.pasive = '0')");
