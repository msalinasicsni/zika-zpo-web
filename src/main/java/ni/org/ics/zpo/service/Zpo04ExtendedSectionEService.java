...
public class Zpo04ExtendedSectionEService {
    ...
    public List<Zpo04ExtendedSectionE> getZpo04ExtendedSectionEByUser(String username){
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createQuery("FROM Zpo04ExtendedSectionE zpo04e where zpo04e.pasive = '0' and zpo04e.recordId in (select zpo00.recordId from Zpo00Screening zpo00 where zpo00.pasive = '0')");
