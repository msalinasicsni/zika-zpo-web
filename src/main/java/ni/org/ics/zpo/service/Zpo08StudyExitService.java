...
public class Zpo08StudyExitService {
    ...
    public List<Zpo08StudyExit> getZpo08StudyExitByUser(String username){
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createQuery("FROM Zpo08StudyExit zpo08 where zpo08.pasive = '0' and zpo08.recordId in (select zpo00.recordId from Zpo00Screening zpo00 where zpo00.pasive = '0' and zpo00.preScreenId in (select recId from ZpoPreScreening zpPre where zpPre.pasive = '0' and zpPre.cs in " +
