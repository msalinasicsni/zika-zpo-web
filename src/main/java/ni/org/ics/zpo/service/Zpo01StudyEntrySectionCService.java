...
public class Zpo01StudyEntrySectionCService {
    ...
    public List<Zpo01StudyEntrySectionC> getZpo01StudyEntrySectionCByUser(String username){
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createQuery("FROM Zpo01StudyEntrySectionC zpo01e where zpo01e.pasive = '0' and zpo01e.recordId in (select zpo00.recordId from Zpo00Screening zpo00 where zpo00.pasive = '0')");
