...
public class Zpo05DeliveryService {
    ...
    public List<Zpo05Delivery> getZpo05DeliveryByUser(String username){
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createQuery("FROM Zpo05Delivery zpo06 where zpo06.pasive = '0' and zpo06.recordId in (select zpo00.recordId from Zpo00Screening zpo00 where zpo00.pasive = '0' and zpo00.preScreenId in (select recId from ZpoPreScreening zpPre where zpPre.pasive = '0' and zpPre.cs in " +
